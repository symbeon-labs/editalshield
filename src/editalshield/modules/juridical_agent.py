...
class JuridicalAgent:
    ...
    def analyze_legal_risk(self, analysis_data: Dict[str, Any]) -> LegalOpinion:
        ...
        risk_level = "LOW"
        recommendation = (
            "O texto parece seguro para submissão. Nenhuma exposição óbvia de PI detectada."
        )
        ...
        return LegalOpinion(
            status=status, risk_level=risk_level, citations=citations, recommendation=recommendation
        )
