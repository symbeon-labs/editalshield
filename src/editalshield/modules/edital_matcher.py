...
class EditalMatcher:
    ...
    def __init__(self, editals_data: List[Dict] = None):
        self.vectorizer = TfidfVectorizer(stop_words='english') # In production, use Portuguese stop words
    ...
    def match_project(self, project_description: str, 
                     sector: str = None, 
                     stage: str = None,
...
if __name__ == "__main__":
    ...
    print("\n--- Test Matching ---")
    project = "Desenvolvimento de software de IA para monitoramento de pragas em soja usando drones."
